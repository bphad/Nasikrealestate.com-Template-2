...
<div class="header-w3layouts"> 
	...
	<nav class="navbar navbar-default">
		<div class="navbar-header page-scroll">
			...
			<h1><a class="logo" href="index.html"><span>A</span>ssets</a></h1>
		</div> 
...
<div class="about-top" id="about">
	<div class="container">
		<h3 class="w3l-title">Welcome To Our Assets </h3>
		...
		<div class="wthree-services-bottom-grids">
			...
			<div class="col-md-6 wthree-services-right first-w3l">
				<div class="wthree-services-right-top">
					...
					<p>Nam tempor pharetra egestas. laoreet massa. Donec tempor ex ultrices nisi commodo consectetur. Maecenas a diam cursus, vehicula ligula vel, fringilla libero. Mauris eu nulla.</p>
				</div>
	...
	<div class="container">
		<div class="footer-top">
			...
			<div class="col-md-4 amet-sed amet-medium">
				<h2><a class="logo" href="index.html">Assets</a></h2>
				<div class="ag-w3-3">
...
<!-- copy right -->
<p class="footer-class">© 2017 Nasikrealestate.com. All Rights Reserved | Design by  <a href="3">Balasaheb B. Phad</a> </p>
<!-- //copy right -->
<!-- //footer --> 
